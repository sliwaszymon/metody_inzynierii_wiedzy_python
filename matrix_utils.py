...
print(MatrixUtils.eigenvalues([[1,1,0], [1,0,1], [0,1,1]], 2))
print(MatrixUtils.eigenvalues([[1,1,0], [1,0,1], [0,1,1]], 3))
print(MatrixUtils.eigenvalues([[1,1,0], [1,0,1], [0,1,1]], 4))
print(MatrixUtils.eigenvalues([[1,1,0], [1,0,1], [0,1,1]], 5))
print(MatrixUtils.eigenvalues([[1,1,0], [1,0,1], [0,1,1]], 10))
print(MatrixUtils.eigenvalues([[1,1,0], [1,0,1], [0,1,1]], 20))